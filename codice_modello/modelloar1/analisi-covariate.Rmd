...
```{r wspeed,include=TRUE,fig.height=6,layout="l-page",eval=F}
try(brinla::bri.band.ggplot(inla.out,name="Transport"))
```


### rw1 su aviation

```{r aviation,include=TRUE,fig.height=6,layout="l-page",eval=F}
try(brinla::bri.band.ggplot(inla.out,name="Aviation"))
```
