...
graficoMappe<-function(intero,mascherato,anni,tipo,max_soglia){
  ...
  purrr::map(1:numeroLayers,.f=function(ll){
    ...
    ggplot()+
      ...
      scico::scale_fill_scico(palette="cork",limits=c(-max_soglia,max_soglia),na.value=NA,direction=1,guide=guide_colorbar(barheight=unit(10,"cm"),title=str_wrap("% relative change",10)))+
