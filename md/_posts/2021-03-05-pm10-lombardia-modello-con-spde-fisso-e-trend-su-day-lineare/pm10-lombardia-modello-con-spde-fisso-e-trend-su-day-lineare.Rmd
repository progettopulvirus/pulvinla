---
title: "PM10 Lombardia, modello con spde fisso e trend su day lineare"
description: |
  Sintesti risultati preliminari.
author:
...
Il trend decrescente viene rappresentato mediante una componente lineare (variabile `day`). L'obiettivo e' capire quanta della variabilita' temporale viene spiegata da `wday` (effetto lineare) e dal valore dell'inquinante nel giorno prima.
