...
```{r conta_cluster1}
table(prova[prova$cluster==1,c("tipo_zona")])
```

#### Cluster2: tipo_zona

```{r conta_cluster2}
table(prova[prova$cluster==2,c("tipo_zona")])
```

#### Cluster1: tipo_stazione

F: Fondo; I: Industriale; T: Traffico

```{r conta_cluster11}
table(prova[prova$cluster==1,c("tipo_stazione")])
```

#### Cluster2: tipo_stazione

```{r conta_cluster22}
table(prova[prova$cluster==2,c("tipo_stazione")])
```
