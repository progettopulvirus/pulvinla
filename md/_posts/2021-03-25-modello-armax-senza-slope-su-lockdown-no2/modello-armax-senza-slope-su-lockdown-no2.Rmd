---
title: "Modello ARMAX senza slope su lockdown, NO2"
description: |
...
Analisi dei risultati del modello ARMAX in cui manca la variazione dello slope (variabile bandalockdown) durante il lockdown (9 marzo - 3 maggio 2020).

$y=\alpha_{0}+\beta_{1} * meteo+\beta_{2} * banda+\beta_{3} * lockdown+\beta_{4} * weekend+\varepsilon$

banda: da 1 a numero di giorni dal primo gennaio 2020 al 3 gennaio 2020

lockdown: pari a 1 durante il lockdown (9 marzo - 3 maggio 2020) altrimenti pari a 0
