---
title: "Esempio heatmap valori no2"
description: |
  Valori di no2, grafico provvisorio da sistemare (se ne vale la pena)
author:
...
Sull'asse delle x sono riportati i giorni dal 1 gennaio al 30 aprile, sull'asse delle y le stazioni del dataset di input, mentre la paletta dei colori rappresenta le concentazioni assolute di NO2 per il 2019 (grafico in alto) e per il 2020 (grafico in basso).
...
ggplot(data=finale,aes(x=indice,y=station_eu_code,fill=no2))+
  ...
  facet_wrap(~yy,scales="free_x",ncol=1)+
