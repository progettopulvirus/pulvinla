---
title: "Esempio heatmap, variazioni percentuali 2020/2019 no2"
description: |
  Grafico provvisorio da sistemare (se ne vale la pena)
author:
...
Sull'asse delle x sono riportati i giorni dal 1 gennaio al 30 aprile, sull'asse delle y le stazioni del dataset di input, mentre la paletta dei colori rappresenta le variazioni percentuali (osservate).

**I buchi sull'asse x dipendono dal fatto che si tratta di un grafico provvisorio.**
