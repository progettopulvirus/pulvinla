---
title: "ARIMAX serie NO2, gennaio-maggio 2020 "
description: |
  Stima modello arimax senza utilizzare il valore dell'inquinante del giorno precedente.
author:
...
- seno e coseno (introdotte per catturare eventuali ciclicita' settimanali non colte da **wday**)
...
purrr::walk(c("U"),.f=function(tipo){
    ...
    purrr::walk(CODICI,.f=function(cc){
      ...
      auto.arima(y=subdati$value,xreg = as.matrix(subdati[,c("banda","t2m","sp","pblmax","pblmin","wdir","wspeed","tp","ptp","seno","coseno","lockdown")]),
